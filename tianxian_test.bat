...
set images_dir=C:\Users\Ethan\Desktop\jiejiaotianxian2\8m
...
openMVG_main_tianxian -i %matches_dir%\sfm_data.json -m %matches_dir% -o %reconstructioon_dir% -a 1 -b 3 -c %images_dir%
